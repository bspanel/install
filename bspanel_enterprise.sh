...
infomenu()
{
	Info "${green}|--------------- | ${CYAN}Добро пожаловать, в установочное меню ${red}BSPanel${green} (${orange}тариф Enterprise Pack${green}) | ---------------|"
}
infomenu2()
{
	Info "${green}|------------------------------------------------------------------------------------------------------|"
...
menu()
{
	...
	Info "• ${red}5${green} - Меню установки ${red}платных шаблонов${green} •"
	Info "• ${red}6${green} - Меню подключения ${red}Веб-мониторинга BSPANEL${green} •"
	Info "• ${red}7${green} - Меню установки ${red}игр${green} •"
